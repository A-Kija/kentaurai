...
window.addEventListener('load', function (_) {
  ...
  button.addEventListener('click', function (_) {
    var animal = input.value;
    input.value = '';
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].post('http://localhost/add-animal', {
      animal: animal
    }).then(function (res) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_041"] = self["webpackChunk_041"] || [];
